...
5.  **Section parsing**: Collect subsequent headings (`## Heading`), extracting text body blocks verbatim.
...
7.  **Global Graph assembly**:
    ...
    *   Enforce type-prefix targets (e.g. `Related Projects` must link to `proj:`).
...
*   **Max Relationships**: `100` links per node.
