...
### Files Created:
*   [enums.go](../model/enums.go)
*   [diagnostic.go](../model/diagnostic.go)
*   [metadata.go](../model/metadata.go)
*   [section.go](../model/section.go)
*   [relationship.go](../model/relationship.go)
*   [object.go](../model/object.go)
*   [knowledge_base.go](../model/knowledge_base.go)
*   [limits.go](../parser/limits.go)
*   [discovery.go](../parser/discovery.go)
*   [parser.go](../parser/parser.go)
*   [validator.go](../validation/validator.go)
*   [json.go](../export/json.go)
